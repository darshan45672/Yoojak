    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3">
          ...
          <p><a href="https://www.ajiet.edu.in/">Learn More</a></p>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-12">
          <div class="copyright">
              <p>
                  ...
                  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by <a href="#" target="_blank" >DevNation</a>
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  </p>
          </div>
        </div>
